...
@WebServlet("/admin-filter-products-by-calories")
public class AdminFilterProductsByCaloriesServlet extends HttpServlet {

    private static final Logger logger = Logger.getLogger(AdminFilterProductsByCaloriesServlet.class.getName());
