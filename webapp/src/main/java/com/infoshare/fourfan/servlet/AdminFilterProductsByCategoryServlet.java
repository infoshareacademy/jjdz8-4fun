...
public class AdminFilterProductsByCategoryServlet extends HttpServlet {

    private static final Logger logger = Logger.getLogger(AdminFilterProductsByCategoryServlet.class.getName());
